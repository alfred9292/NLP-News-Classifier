...
df = pd.read_csv("/Users/alfred/PycharmProjects/nlp/virality.csv",delimiter=',', skiprows=1, header=None)

#combine title and content as feature vector for training and testing, split the data into training set and test set, intend to divide all dataset to training set to faciliate the 10 kold cross validation at later stage#
X_train_raw,X_test_raw,y_train,y_test = train_test_split(df[2]+df[3],df[0],test_size=0,random_state=0)
